  ...
  Widget buildEmpty() {
    if (ComicSource.isEmpty) {
      return EmptyState(
        ...
        title: "No Comic Sources".tl,
        subtitle: "Add comic sources to start exploring".tl,
        withAppbar: false,
        actions: [
          FilledButton.icon(
            onPressed: () {
      ...
      return EmptyState(
        ...
        subtitle: "Select pages to display in explore section".tl,
        withAppbar: false,
        actions: [
          FilledButton.icon(
            onPressed: addPage,
            icon: const Icon(Icons.add),
            label: Text("Add Page".tl),
          ),
        ],
      );
    }
