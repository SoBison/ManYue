  ...
  Widget build(BuildContext context) {
    return SmoothCustomScrollView(
      slivers: [
        ...
        // 连接设置分组
        ModernSectionTitle(
          title: "Connection Settings".tl,
          icon: Icons.wifi,
          subtitle: "Configure network connection and proxy".tl,
        ).toSliver(),
        ...
        SettingCard(
          children: [
            ModernActionSetting(
              title: "Proxy".tl,
              callback: () =>
                  showPopUpWidget(App.rootContext, const _ProxySettingView()),
            ...
            ModernActionSetting(
              ...
              callback: () =>
                  showPopUpWidget(App.rootContext, const _DNSOverrides()),
              actionTitle: "Configure".tl,
              icon: Icons.dns,
              actionIcon: Icons.settings,
            ),
        ...
        // 性能设置分组
        ModernSectionTitle(
          title: "Performance Settings".tl,
          icon: Icons.speed,
          subtitle: "Optimize download and network performance".tl,
        ).toSliver(),
        ...
        SettingCard(
          children: [
            ...
            ModernSwitchSetting(
              title: "URL Filtering".tl,
              subtitle:
                  "Block requests to large websites that may cause performance issues"
                      .tl,
              settingKey: 'enableUrlFiltering',
